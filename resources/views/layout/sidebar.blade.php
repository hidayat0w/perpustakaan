    ...
    <aside id="sidebar-wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="">
          ...
          <li class="">
            <a href="/penerbit" class="nav-link"><i class="fas fa-pen"></i><span>Penerbit</span></a>
          </li>
          <li class="">
          ...
          <li class="">
            <a href="#" class="nav-link"><i class="fas fa-user"></i><span>Peminjaman</span></a>
          </li>
          <li class="">
            <a href="#" class="nav-link"><i class="fas fa-poo"></i><span>Kembali</span></a>
          </li>
